...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+91) 9834570499",
    action: () => (window.location.href = "tel:+919834570499"),
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "phalkemm159@gmail.com",
    action: () => (window.location.href = "mailto:phalkemm159@gmail.com"),
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Location",
    ...
    action: () =>
      window.open("https://www.google.com/maps/place/Pune,+Maharashtra", "_blank"),
  },
];
